...
def _oscar_decode_hp_stage1(
    ...
    bid = tl.program_id(0)
    kv_head = tl.program_id(1)
    sid = tl.program_id(2) - HP_PARTIAL_START
    head0 = kv_head * KV_GROUP_SIZE
...
@triton.jit
def _oscar_decode_grouped_h4_stage1(
    Q_rot_ptr,
    K_data_ptr,
    V_data_ptr,
    K_meta_pair_ptr,
    ...
    HP_BLOCK_N: tl.constexpr,
    HP_BLOCK_H: tl.constexpr,
):
    """Process quant and BF16 HP partials in one Grouped-H4 stage."""
    if tl.program_id(2) < NUM_QUANT_SPLITS:
        _oscar_decode_quant_stage1_grouped_h4(
            ...
            stride_mid_s,
            HEAD_DIM=HEAD_DIM,
            NUM_QUANT_SPLITS=NUM_QUANT_SPLITS,
        ...
        _oscar_decode_hp_stage1(
            ...
            HP_PARTIAL_START=HP_PARTIAL_START,
            BLOCK_D=BLOCK_D,
            BLOCK_N=HP_BLOCK_N,
            BLOCK_H=HP_BLOCK_H,
        )
